...
public class vista extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lbpuntajeo.setFont(new java.awt.Font("Segoe UI Emoji", 1, 18)); // NOI18N
        lbpuntajeo.setText("0");

        lbpuntajex.setFont(new java.awt.Font("Segoe UI Emoji", 1, 18)); // NOI18N
    ...
    public void presionar(int casilla){
        if (lbs[casilla-1].getText().equals("")&&est){   
